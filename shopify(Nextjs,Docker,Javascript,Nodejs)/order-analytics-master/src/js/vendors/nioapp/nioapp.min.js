var NioApp = (function (c, l) {
  ...
  return (
    ...
    (c.Slider = {}),
    (c.Picker = {}),
    (c.Win = { height: t.height(), width: t.outerWidth() }),
    (c.Break = {
      mb: 420,
      sm: 576,
      md: 768,
    ...
    (c.isDark = !(!r.hasClass("dark-mode") && "dark" !== r.data("theme"))),
    (c.State = {
      isRTL: !(!r.hasClass("has-rtl") && "rtl" !== r.attr("dir")),
      isTouch: "ontouchstart" in document.documentElement,
      isMobile: !!navigator.userAgent.match(
        /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini|Windows Phone|/i
      ),
      asMobile: c.Win.width < c.Break.md,
      asServe: c.Host.name.split(".").indexOf(c.Host.locat),
    }),
    (c.hexRGB = function (e, t) {
      var a,
        o,
        i = t || 1;
    ...
    (c.StateUpdate = function () {
      (c.Win = { height: t.height(), width: t.outerWidth() }),
        (c.State.asMobile = c.Win.width < c.Break.md);
    }),
    (c.ClassInit = function () {
      function e() {
        !0 === c.State.asMobile
          ? r.addClass("as-mobile")
          : r.removeClass("as-mobile");
      }
      !0 === c.State.isTouch ? r.addClass("has-touch") : r.addClass("no-touch"),
        e(),
        !0 === c.State.isRTL && r.addClass("has-rtl"),
        r.addClass("nk-" + a),
        t.on("resize", e);
    }),
    (c.ColorBG = function () {
    ...
    (c.BreakClass = function (e, t, a) {
      var o = e || ".header-menu",
        i = t || c.Break.md,
        s = { timeOut: 1e3, classAdd: "mobile-menu" },
        n = a ? d(s, a) : s,
        r = !!n.ignore && n.ignore;
      if (r && l(o).hasClass(r)) return !1;
      c.Win.width < i
        ? setTimeout(function () {
            c.Win.width < i && l(o).addClass(n.classAdd);
          }, n.timeOut)
        : l(o).removeClass(n.classAdd);
    }),
    (c.Passcode = function (e, t) {
        ...
        l(e).on("click", function (e) {
          ...
          e.preventDefault(),
            o.hasClass(i.showClass)
              ? (t.add(o).addClass(i.hideClass).removeClass(i.showClass),
                o.attr("type", "password"))
              : (t.add(o).addClass(i.showClass).removeClass(i.hideClass),
                o.attr("type", "text"));
        });
    }),
    (c.LinkOff = function (e) {
      l(e).on("click", function (e) {
        e.preventDefault();
      });
    }),
    (c.SetHW = function (e, t) {
    ...
    (c.AddInBody = function (e, t) {
      ...
      (o.prefix = !1 !== o.prefix ? o.prefix : ""),
        (o.has = "" !== o.has ? o.has + "-" : ""),
        (s = "" !== o.class ? o.class : o.has + s),
        l("." + o.prefix + i).exists() && !r.hasClass(s) && r.addClass(s);
    }),
    (c.Toggle = {
      trigger: function (e, t) {
        var a = {
          ...
          i = l("[data-target=" + e + "]"),
          s = l("[data-" + o.data + "=" + e + "]"),
          n = s.data("toggle-body");
        s.data("toggle-overlay") && (o.overlay = o.olay),
          n && (o.body = "toggle-shown"),
          s.hasClass(o.content)
            ? (i.removeClass(o.active),
              1 == o.toggle
                ? s.slideUp(o.speed).removeClass(o.content)
                : s.removeClass(o.content))
            : (i.addClass(o.active),
              1 == o.toggle
                ? s.slideDown(o.speed).addClass(o.content)
                : s.addClass(o.content)),
          o.body && r.toggleClass(o.body),
          o.overlay && this.overlay(s, o.overlay, o);
      },
      removed: function (e, t) {
        ...
        s.data("toggle-overlay") && (o.overlay = o.olay),
          n && (o.body = "toggle-shown"),
          (i.hasClass(o.active) || s.hasClass(o.content)) &&
            (i.removeClass(o.active),
            s.removeClass(o.content),
            !0 === o.toggle && s.slideUp(o.speed)),
          o.body && r.hasClass(o.body) && r.removeClass(o.body),
          o.close &&
            (!0 === o.close.profile && this.closeProfile(s),
            !0 === o.close.menu && this.closeMenu(s)),
          o.overlay && this.overlayRemove(o.overlay);
      },
      overlay: function (e, t, a) {
        var o;
        !0 === a.break &&
          ((o = l(e).data("toggle-screen")), (a.break = c.Break[o])),
          l(e).hasClass(a.content) && c.Win.width < a.break
            ? l(e).after(
      ...
      dropMenu: function (e, t) {
        var a = {
          ...
          o = t ? d(a, t) : a,
          i = l(e).parent(),
          s = i.children("." + o.child);
        (o.speed =
          5 < s.children().length
            ? o.speed + 20 * s.children().length
            : o.speed),
          s
            .slideToggle(o.speed)
            .find("." + o.child)
      ...
      closeProfile: function (e) {
        ...
        t.exists() &&
          (t.removeClass("active"), a.slideUp().removeClass("expanded"));
      },
    ...
    (c.Picker.dob = function (e, t) {
      var a = { startView: 2, todayHighlight: !1 },
        o = t ? d(a, t) : a;
      c.Picker.date(e, o);
    }),
    (c.Picker.time = function (e, i) {
      l(e).exists() &&
        ...
        l(e).each(function () {
          var e = l(this).attr("id"),
            ...
            a = {
              start: [25],
              connect: "lower",
              direction: c.State.isRTL ? "rtl" : "ltr",
              range: { min: 0, max: 100 },
            },
            o = i ? d(a, i) : a;
    ...
    (c.coreInit = function () {
      c.coms.onResize.push(c.StateUpdate), c.coms.docReady.push(c.ClassInit);
    }),
    c.coreInit(),
    c
  );
  ...
  (NioApp = (function (e, t, a) {
    "use strict";
    var o = {
        AppInfo: { name: "NioApp", version: "1.0.6", author: "Softnio" },
        Package: { name: "DashLite", version: "1.9.2" },
      },
      i = {
        docReady: [],
        docReadyDefer: [],
